...
<div class="lg:hidden flex items-center justify-between px-5 py-4"
    ...
    <div class="flex items-center gap-2">
        ...
        <span class="text-white font-bold tracking-wide text-base" style="letter-spacing: 0.05em;">Emplify</span>
    </div>
...
<div id="sidebar"
    ...
    <!-- Logo -->
    <div class="flex items-center gap-3 px-6 py-6" style="border-bottom: 1px solid rgba(255,255,255,0.06);">
    ...
    <!-- <div class="px-5 pt-5 pb-2">
        <span class="text-xs font-semibold uppercase" style="color: rgba(148,163,184,0.4); letter-spacing: 0.15em;">Main Menu</span>
    </div> -->

    <!-- Navigation -->
    <nav class="flex flex-col px-3 space-y-1 flex-1 overflow-y-auto" style="scrollbar-width: none; -ms-overflow-style: none;">

        <?php
        $nav_items = [
            ['href' => 'dashboard.php',      'icon' => 'fa-home',          'label' => 'Dashboard'],
            ['href' => 'employees.php',      'icon' => 'fa-users',         'label' => 'Employees'],
            ['href' => 'attendance.php',     'icon' => 'fa-clock',         'label' => 'Attendance'],
            ['href' => 'department.php',     'icon' => 'fa-building',      'label' => 'Department'],
            ['href' => 'designation.php',    'icon' => 'fa-id-badge',      'label' => 'Designation'],
            ['href' => 'leave_approval.php', 'icon' => 'fa-calendar-check','label' => 'Leave Approval'],
            ['href' => 'task_assign.php',    'icon' => 'fa-tasks',         'label' => 'Task Assign'],
            ['href' => 'visit-reports.php',  'icon' => 'fa-chart-bar',     'label' => 'Visit Reports'],
            ['href' => 'admin_feedback.php', 'icon' => 'fa-comment',       'label' => 'Feedback'],
        ];
        ...
        <a href="<?php echo $item['href']; ?>"
           ...
           ">
            <?php if ($active): ?>
            <div class="absolute left-0 top-1/2 -translate-y-1/2 w-0.5 h-5 rounded-r-full" style="background: #6366f1;"></div>
            <?php endif; ?>
